...
class Settings(BaseSettings):
    ...
    # Модуль оплаты не подключён: кассы и фискального накопителя пока нет.
    # Пока False, бот на шаге оплаты передаёт заказ менеджеру обычной
    # эскалацией — клиент не остаётся с «ссылка скоро будет» и тишиной.
